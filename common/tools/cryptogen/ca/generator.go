...
// baseDir/name
func NewCA(baseDir, org, name, country, province, locality, orgUnit, streetAddress, postalCode, sigAlgo string) (*CA, error) {
	...
	if err == nil {
		priv, signer, err := csp.GeneratePrivateKey(baseDir, sigAlgo)
		response = err
		if err == nil {
