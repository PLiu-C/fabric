...
const badConnectURL = "mongodb:2701" // should be sth like "mongodb://localhost:27017"
...
func cleanupCollection(collection string) error {
	...
	mongoInstance, err := CreateMongoInstance(testConfig(), &disabled.Provider{})
	if err != nil {
		return err
	}
...
func startMongoDB() {
	if testAddress == "" {
		testAddress, cleanupMongoDB = mongodbtest.MongoDBSetup()
	}
}
...
func TestHealthCheck(t *testing.T) {
	...
	badConnectDef := testConfig()
	badConnectDef.Address = testAddress + "1"
